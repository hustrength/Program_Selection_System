    ...
    <div class="login-wrap">
        <div class="login-html">
            ...
            <div class="login-form">
                <form id="form_login" method='post' onsubmit='commitForm_signin(this)'>
                    <div class="sign-in-htm">
                        <div><br></div>
                        <div><br></div>
                        <div class="group1">
                            <label for="userid_signin" class="label1">编号</label>
                            <input id="userid_signin" type="text" class="input1" required="required"
                                   oninvalid="setCustomValidity('该项不可为空')" oninput="setCustomValidity('')">
                        </div>
                        <div><br></div>
                        <div><br></div>
                        <div class="group1">
                            ...
                            <input id="password_signin" type="password" class="input1" data-type="password"
                                   required="required"
                                   oninvalid="setCustomValidity('该项不可为空')" oninput="setCustomValidity('')">
                        </div>
                        <div><br></div>
                        ...
                        <div class="group1">
                            ...
                            <select class="input1" name="status" id="status" required="required" style="height:40px"
                                ...
                                <option class="input_bt" value="1">学生</option>
                                <option class="input_bt" value="2">教师</option>
                            </select>
                        </div>
                        <div><br></div>
                        <div><br></div>
                ...
                <form id="form_register" name="form_register" method="post" onsubmit='commitForm_signup(this)'>
                    <div class="sign-up-htm">
                        ...
                        <div class="group">
                            ...
                            <input id="username" type="text" class="input" required="required"
                                   oninvalid="setCustomValidity('该项不可为空')" oninput="setCustomValidity('')">
                        </div>
                        <div class="group">
                        ...
                        <div class="group">
                            <label for="classroom" class="label">班级</label>
                            <select class="input" name="classroom" id="classroom" required="required"
                                    style="height:30px"
                                    oninvalid="setCustomValidity('该项不可为空')" oninput="setCustomValidity('')">
                                <option class="input_bt" value="" selected>--请选择--</option>
