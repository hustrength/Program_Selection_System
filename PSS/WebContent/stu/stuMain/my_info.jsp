				 ...
				 个人信息
							...
							<div class="panel-body"> 
								<div class="alert alert-success">
									<strong>学号</strong> You successfully read this important alert message.
								</div>
								<div class="alert alert-info">
									<strong>姓名</strong> This alert needs your attention, but it's not super important.
								</div>
								<div class="alert alert-warning">
									<strong>性别</strong> Best check yo self, you're not looking too good.
								</div>
								<div class="alert alert-danger">
									<strong>班级</strong> Change a few things up and try submitting again.
								</div>
								<div class="alert alert-success">
									<strong>所属团队</strong> You successfully read this important alert message.
								</div>
								<div class="alert alert-info">
									<strong>团队职位</strong> This alert needs your attention, but it's not super important.
								</div>
								<div class="alert alert-warning">
									<strong>课题得分</strong> Best check yo self, you're not looking too good.
								</div>
								<!-- <div class="alert alert-danger">
									<strong>班级</strong> Change a few things up and try submitting again.
								</div> -->
